  ...
  return (
    <>
      ...
      <body>
        <section className="flex flex-col justify-between h-screen ">
          ...
          <div className="flex  mt-28 relative">
            ...
            <div className="flex">
              <div className="w-1/2">
                    <p className="w-[90%] m-auto ml-0 text-justify mt-4">
      ...
      <div className="flex flex-col md:flex-row items-center mt-10">
        ...
        <form className="w-full" name="contactUS" method="POST">
          <label
            // for="name"
            className="block mb-2 text-sm font-medium text-[#1595b6] dark:text-white">
              Name
            </label>
          <div className="relative mb-4">
            ...
            <input
              ...
              id="name"
              name="name"
              className="bg-gray-50 border-2 outline-none border-gray-300 text-[#1595b6] text-sm rounded-lg focus:ring-[#1788ae] focus:border-[#1788ae] block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
          ...
          <div className="relative mb-4">
            ...
            <textarea
              ...
              name="message"
              // rows="8"
              className="bg-gray-50 border-2 outline-none border-gray-300 text-[#1595b6] text-sm rounded-lg focus:ring-[#1788ae] focus:border-[#1788ae] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
            ></textarea>
          </div>
          <button
            type="submit"
